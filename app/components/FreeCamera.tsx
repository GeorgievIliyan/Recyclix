              ...
              <div className="absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t from-black/60 to-transparent p-4 md:p-6 lg:p-8">
                <div className="flex items-center justify-center">
                  <button
                    ...
                    disabled={loading}
                    className="
                    group/btn relative px-6 py-3 md:px-8 md:py-4 lg:px-10 lg:py-4
                    bg-gradient-to-br from-[#00CD56] via-emerald-500 to-[#00b849] 
                    hover:from-[#00b849] hover:via-[#00a341] hover:to-emerald-600
                    text-white font-semibold rounded-lg md:rounded-xl
                    transition-all duration-200 
                    shadow-lg shadow-[#00CD56]/20 hover:shadow-xl hover:shadow-[#00CD56]/30 
                ...
                "
                  >
                    ...
                    <button
                      ...
                      className="
                      group/btn relative w-full px-4 py-2.5 md:px-5 md:py-3 lg:px-6 lg:py-3.5
                    ...
                    "
                    >
                      <span className="relative z-10">Опитай отново</span>
                      <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" />
                    </button>
                  </div>
                </div>
