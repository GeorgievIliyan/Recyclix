...
export default function ConfirmCamera({
  ...
  const confirmTask = async () => {
    ...
    try {
      console.log(
        "ConfirmCamera: Sending image to confirm API for task:",
        userDailyTaskId,
      );
      ...
      if (!res.ok) {
        throw new Error(
          data.error || `HTTP ${res.status}: Failed to verify image`,
        );
      }
          ...
          <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-semibold text-red-500 flex gap-1">
                ...
                <p className="text-xs text-red-500 mt-2">
                  ...
                  {!apiResult.error && (
                    <span className="block mt-1">
                      Снимката не съответства на задачата. Опитайте отново.
                    </span>
                  )}
                </p>
