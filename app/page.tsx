...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-zinc-50 via-zinc-100 to-zinc-200 dark:from-zinc-950 dark:via-zinc-900 dark:to-black">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="flex items-center gap-3">
                <a
                  href="/auth/login"
                  className="px-5 py-2 text-zinc-700 dark:text-zinc-300 hover:text-[#00CD56] dark:hover:text-[#00CD56] transition-colors font-medium"
                >
                  Вход
                </a>
                <a
      ...
      <div
        id="hero"
        className="relative min-h-[85vh] flex items-center justify-center p-4 overflow-hidden pt-16"
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="mb-6">
            ...
            <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 max-w-3xl mx-auto leading-relaxed">
              Присъединете се към нашата платформа за рециклиране и помогнете за
              опазване на околната среда. Лесно, бързо и ефективно.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <a
              href="/auth/register"
              className="group relative w-full sm:w-auto px-10 py-4 bg-gradient-to-br from-[#00CD56] via-emerald-500 to-[#00b849] hover:from-[#00b849] hover:via-[#00a341] hover:to-emerald-600 text-white text-lg font-semibold rounded-2xl shadow-2xl shadow-[#00CD56]/30 dark:shadow-[#00CD56]/20 transition-all duration-300 hover:scale-105 active:scale-95 hover:shadow-[#00CD56]/40"
            >
      ...
      <div id="features" className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Лесно рециклиране",
                desc: "Намерете най-близките пунктове за рециклиране и научете какво може да се рециклира с интерактивната ни карта.",
                icon: (
                  <path d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                ),
              },
              {
                title: "Печелете награди",
                desc: "Получавайте точки и награди за всяко рециклиране. Разменете точките си за ваучери и отстъпки.",
                icon: (
                  <path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                ),
              },
              {
                title: "Присъединете се",
                desc: "Споделяйте опит, вдъхновявайте други и участвайте в предизвикателства за рециклиране.",
                icon: (
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-4 bg-gradient-to-r from-zinc-100/80 to-zinc-50/80 dark:from-zinc-950/40 dark:to-zinc-900/40 rounded-xl border border-zinc-200/30 dark:border-zinc-800/50 hover:border-[#00CD56]/30 transition-all duration-300">
                    ...
                    <span className="text-2xl font-bold bg-gradient-to-br from-[#00CD56] via-emerald-500 to-[#00b849] bg-clip-text text-transparent">
                      {co2ToWater(totalC02Reduction)} литра
                    </span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-gradient-to-r from-zinc-100/80 to-zinc-50/80 dark:from-zinc-950/40 dark:to-zinc-900/40 rounded-xl border border-zinc-200/30 dark:border-zinc-800/50 hover:border-[#00CD56]/30 transition-all duration-300">
                    <span className="text-zinc-700 dark:text-zinc-300 font-medium">
                    ...
                    <span className="text-2xl font-bold bg-gradient-to-br from-[#00CD56] via-emerald-500 to-[#00b849] bg-clip-text text-transparent">
                      {co2ToKwh(totalC02Reduction)} kWh
                    </span>
                  </div>
                </div>
              </div>
